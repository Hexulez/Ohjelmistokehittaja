...
namespace Tehtävä18_HarjoitusOppilaitostenTiedoilla
{
    public partial class Form1 : Form
    {
        ...
        private void oppilaitosCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            vastuuHenkCB.DataSource = yhteys;
            vastuuHenkCB.DisplayMember = "VNimi";
        }

        private void vastuuHenkCB_TextChanged(object sender, EventArgs e)
        {
            titteliLB.Text = yhteys.Rows[vastuuHenkCB.SelectedIndex]["VTitteli"].ToString();
            sijaintiLB.Text = yhteys.Rows[vastuuHenkCB.SelectedIndex]["VSijainti"].ToString();
            emailLB.Text = yhteys.Rows[vastuuHenkCB.SelectedIndex]["VSahkoposti"].ToString();
            phoneLB.Text = yhteys.Rows[vastuuHenkCB.SelectedIndex]["VPuhelin"].ToString();
        }
        ...
        private void taytaOppilaitosTaulukko()
        {
            ...
            oppilaitos.Columns.Add("OKatuosoite"); oppilaitos.Columns.Add("OPostitoimipaikka"); 
